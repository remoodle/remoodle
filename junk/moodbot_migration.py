...
def main():
    parser = argparse.ArgumentParser(description="Data migration tool with encryption support.")
    parser.add_argument("secret_key", type=str, help="The secret key for Fernet encryption/decryption.")
